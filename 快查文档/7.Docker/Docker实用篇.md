...
容器操作的命令如图：
![image-20230821213740707](Docker实用篇.assets/image-20230821213740707.png)
...
```sh
sed -i -e 's#Welcome to nginx#你好，世界！#g' -e 's#<head>#<head><meta charset="utf-8">#g' index.html
```
